...
pub use orchestration::{
    ...
    compile_unified_script, cross, display_name_for_script, ema, eval_series_primary, macd,
    normalize_for_series_eval, normalize_script_for_compile, parse, parse_script_entry_point_name,
    parse_script_scalar_uniforms, parse_script_signature, otl_wirable_series_inputs,
    parse_with_context,
    resolve_otl_script_src, rsi, set_script_uniform_default, merge_script_scalar_uniforms, sma, spread_sign, tokenize, BinOp, CompileError,
    ...
    ComposedAssetMeta, PathBindingIndex, PortfolioTrackingFrame, SeriesClosure, SeriesEvalBuffer,
    SeriesEvalContext, SignalTransformFn,
...
pub use frontend::{
    apply_alpha_conviction, canonicalize_otl_source, compile_object_program,
    conviction_scale_from_signal_series, format_object, format_program,
    object_kind_from_token, otl_default_template, parse_program as parse_object_program,
    OTL_DEFAULT_TEMPLATE,
    resolve_runtime_script_source, series_expression_from_source, signal_expression_from_object,
    signal_object_from_expression, shader_object_from_osl_source,
    ResolvedOtlSource,
